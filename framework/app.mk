...
srcsubdirs := $(shell find $(APPLICATION_DIR)/src $(APPLICATION_DIR)/test/src -maxdepth 1 -type d -not -path '*/.libs*')
allsrcsubdirs := $(shell find $(APPLICATION_DIR)/src $(APPLICATION_DIR)/test/src -type d -not -path '*/.libs*')
