...
class ChangeOverPicardPostprocessor;

template <>
InputParameters validParams<ChangeOverPicardPostprocessor>();
 ...
 */
class ChangeOverPicardPostprocessor : public GeneralPostprocessor
{
public:
  static InputParameters validParams();

  ChangeOverPicardPostprocessor(const InputParameters & parameters);
