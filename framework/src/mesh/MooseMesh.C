...
{
  mooseDeprecated(
      "MooseMesh::getBoundariesToElems is deprecated, "
...
const std::unordered_set<dof_id_type> MooseMesh::getBoundaryActiveLocalElemIds(BoundaryID bid) const
{
...
const std::unordered_set<dof_id_type> MooseMesh::getBoundaryActiveNeighborElemIds(BoundaryID bid) const
{
