...
#include "InternalSideIntegralFunctorPostprocessor.h"

#include "metaphysicl/raw_type.h"

registerMooseObject("MooseApp", InternalSideIntegralFunctorPostprocessor);
registerMooseObject("MooseApp", InternalSideIntegralADFunctorPostprocessor);

template <bool is_ad>
InputParameters
InternalSideIntegralFunctorPostprocessorTempl<is_ad>::validParams()
{
...
template <bool is_ad>
InternalSideIntegralFunctorPostprocessorTempl<is_ad>::InternalSideIntegralFunctorPostprocessorTempl(
...
template <bool is_ad>
Real
InternalSideIntegralFunctorPostprocessorTempl<is_ad>::computeQpIntegral()
{
...
template class InternalSideIntegralFunctorPostprocessorTempl<false>;
template class InternalSideIntegralFunctorPostprocessorTempl<true>;
