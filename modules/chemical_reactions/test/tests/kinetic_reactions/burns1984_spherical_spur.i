# =====================================================================
# Burns, Sims & Goodall (1984) spherical-spur water-radiolysis case,
# assembled with the KineticReactionsPhysics. This is the same problem as
# the standalone input but the 7-species diffusion-reaction system (Variables,
# TimeDerivative/diffusion/reaction kernels and materials) is generated by the
# [Physics/KineticReactions] block from the reaction list + diffusivities.
#
# Units: mol, dm, s.  r = x in dm (1 nm = 1e-8 dm).
# =====================================================================

# TODO: add the scavengers
