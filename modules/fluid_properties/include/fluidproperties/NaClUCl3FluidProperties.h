...
/**
 *  Fluid properties for 66% NaCl - 33% UCl3 salt.
 */
class NaClUCl3FluidProperties : public SinglePhaseFluidProperties
{
...
public:
  ...
  NaClUCl3FluidProperties(const InputParameters & parameters);
...
private:
  /// Melting temperature of the NaCl-UCl3 salt
  static constexpr Real _T_mo = 796.15;
};
