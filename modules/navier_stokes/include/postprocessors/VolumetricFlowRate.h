...
protected:
  ...
  const MooseVariableFV<Real> * _fv_vel_x;
  const MooseVariableFV<Real> * _fv_vel_y;
  const MooseVariableFV<Real> * _fv_vel_z;

  /// Advected quantities
  const VariableValue & _advected_variable;
  const MooseVariableFV<Real> * _fv_advected_variable;
