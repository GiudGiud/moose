...
The easiest way to set up a homogenization problem is to use the [SolidMechanics/QuasiStaticAction](/Physics/SolidMechanics/QuasiStatic/index.md)
...
the appropriate options in the [SolidMechanics/QuasiStaticAction](/Physics/SolidMechanics/QuasiStatic/index.md).
