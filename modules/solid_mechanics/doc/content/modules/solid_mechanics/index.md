...
- [Cohesive Zone Modeling](CohesiveZoneModel/index.md)
...
Both the new and old systems are accessible through the [SolidMechanics/QuasiStaticAction](/Physics/SolidMechanics/QuasiStatic/index.md), which simplifies the process of
