...
associateSyntaxInner(Syntax & syntax, ActionFactory & /*action_factory*/)
{
  ...
  registerDeprecatedSyntax(
      ...
      "'Physics/SolidMechanics/LineElementStatic' instead.");
  registerDeprecatedSyntax(
      "LineElementAction",
      "Modules/TensorMechanics/LineElementMaster/*",
      "The 'Modules/TensorMechanics/LineElementMaster' syntax is deprecated. Please use "
  ...
  registerDeprecatedSyntax(
      ...
      "'Physics/SolidMechanics/CohesiveZoneModel' instead.");
  registerDeprecatedSyntax(
      "CohesiveZoneAction",
      "Modules/TensorMechanics/CohesiveZoneMaster/*",
      "The 'Modules/TensorMechanics/CohesiveZoneMaster' syntax is deprecated. Please use "
  ...
  registerSyntax("CommonLineElementAction", "Physics/SolidMechanics/LineElementStatic");
  registerSyntax("LineElementAction", "Physics/SolidMechanics/LineElementStatic/*");

  registerSyntax("CommonCohesiveZoneAction", "Physics/SolidMechanics/CohesiveZoneModel");
  registerSyntax("CohesiveZoneAction", "Physics/SolidMechanics/CohesiveZoneModel/*");
